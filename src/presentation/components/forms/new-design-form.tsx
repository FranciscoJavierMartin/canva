...
export default component$(() => {
  ...
  return (
    <div class='group'>
      <button class='absolute right-3 top-3 rounded-md bg-blue-off px-4 py-2 text-center font-medium text-white hover:bg-blue-dark'>
        Custom size
      </button>
      <Form
        action={createNewDesign}
        class='absolute right-3 top-16 z-20 hidden w-[250px] gap-3 rounded-md bg-black-light p-4 text-white transition-all duration-500 group-focus-within:block'
      >
        ...
        <button
          ...
          type='submit'
          class='w-full rounded-md bg-blue-off px-4 py-2 text-center font-medium text-white hover:bg-blue-dark'
        >
          Create new design
        </button>
      </Form>
