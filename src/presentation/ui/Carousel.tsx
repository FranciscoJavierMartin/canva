    ...
    <div class='no-scrollbar inline-flex snap-mandatory overflow-x-scroll scroll-smooth'>
      <div class='box-content flex flex-none snap-start'>
        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((d) => (
          <div key={d} class='group relative h-[170px] w-full px-2'>
            ...
            <div class='absolute right-5 top-3 hidden cursor-pointer rounded-md bg-white p-1 text-red-500 transition-all duration-500 group-hover:block'>
              <Trash />
            </div>
          </div>
        ))}
